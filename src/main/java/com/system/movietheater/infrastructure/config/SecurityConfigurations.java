package com.system.movietheater.infrastructure.config;

import com.system.movietheater.infrastructure.config.security.SecurityFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(req -> {
                    ...
                    req.requestMatchers(HttpMethod.POST, "/cinema/sala").hasAnyRole("MOVIETHEATER", "ADMIN");
                    req.requestMatchers(HttpMethod.POST, "/cinema/horario").hasAnyRole("MOVIETHEATER", "ADMIN");
                    req.requestMatchers(HttpMethod.POST, "/cinema/filme").hasAnyRole("MOVIETHEATER", "ADMIN");
                    req.requestMatchers(HttpMethod.POST, "/cinema/sessao").hasAnyRole("MOVIETHEATER", "ADMIN");
                    ...
                    req.requestMatchers(HttpMethod.PUT, "/cinema").hasAnyRole("MOVIETHEATER", "ADMIN");
                    req.requestMatchers(HttpMethod.PUT, "/cinema/horario").hasAnyRole("MOVIETHEATER", "ADMIN");
                    req.requestMatchers(HttpMethod.PUT, "/cinema/filme").hasAnyRole("MOVIETHEATER", "ADMIN");
                    req.requestMatchers(HttpMethod.DELETE, "/usuario").hasAnyRole("USER", "MOVIETHEATER", "ADMIN");
                    req.requestMatchers(HttpMethod.DELETE, "/cinema/horario/{id}").hasAnyRole("MOVIETHEATER", "ADMIN");
                    req.requestMatchers(HttpMethod.DELETE, "/cinema").hasAnyRole("MOVIETHEATER", "ADMIN");
